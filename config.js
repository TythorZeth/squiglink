...
const init_phones = ["BKF"],            // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      rig_description = "",                         // Optional. Labels the graph with a description of the rig used to make the measurement, e.g. "clone IEC 711"
      page_title = "Tythor Zeth Graphs",            // Optional. Appended to the page title if share URLs are enabled
